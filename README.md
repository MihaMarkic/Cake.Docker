...
Contributions welcome - but only for generic code, not for specific commands. The reason being is that the actual code is autogenerated from docker sources.
